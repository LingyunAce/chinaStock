...
> **与 其他工具 的分工**：
> - **westock-data**（本工具）：查询个股详情 — "查某只股票的行情/K线/财务/资金等数据"、"查某只股票的风险事件"、"查宏观经济数据"、"查某只股票的新闻/公告/研报"、"查市场资讯"、"查陆股通成份股"、"查ETF详情/持仓/持有人"、**"查板块/概念成份股"**（如"华为概念有哪些股票"→ `sector --search 华为` → `sector <代码>`）
